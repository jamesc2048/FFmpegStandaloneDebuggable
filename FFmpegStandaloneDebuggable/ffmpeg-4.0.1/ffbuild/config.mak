...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-static --disable-shared --disable-pthreads --disable-os2threads --disable-w32threads --disable-optimizations --disable-libv4l2 --disable-v4l2-m2m
prefix=/usr/local
...
CC_IDENT=gcc 7 (Ubuntu 7.3.0-16ubuntu3)
ARCH=x86
INTRINSICS=none
EXTERN_PREFIX=
CC=gcc
...
CFLAGS=   -std=c11 -fPIC -I/usr/include/alsa    -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation  -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized -D_REENTRANT -I/usr/include/SDL2
...
EXTRALIBS-avcodec=-lm -lz
EXTRALIBS-avdevice=-lXv -lX11 -lXext -lm -lxcb -lxcb-shape -lxcb-xfixes -lasound -lSDL2 -lsndio
