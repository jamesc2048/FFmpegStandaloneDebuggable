...
=item B<-dn (>I<output>B<)>

Disable data recording. For full manual control see the C<-map>
option.
...
Disable video recording. For full manual control see the C<-map>
option.
...
Disable audio recording. For full manual control see the C<-map>
option.
...
Disable subtitle recording. For full manual control see the C<-map>
option.
