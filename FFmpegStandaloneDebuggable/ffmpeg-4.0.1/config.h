...
#define FFMPEG_CONFIGURATION "--enable-static --disable-shared --disable-pthreads --disable-os2threads --disable-w32threads --disable-optimizations --disable-libv4l2 --disable-v4l2-m2m"
