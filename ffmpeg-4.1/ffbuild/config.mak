...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-optimizations --enable-debug --disable-asm
prefix=/usr/local
...
avutil_FFLIBS=
EXTRALIBS-avdevice=-lm -lxcb -lxcb-shape -lxcb-xfixes -lasound -lSDL2 -lsndio -lXv -lX11 -lXext
